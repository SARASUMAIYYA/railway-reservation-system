                    ...
                    <Row style={{ alignItems: 'center', justifyContent: 'center', margin: 30 }}>
                        <Col>
                            <div id="page">
                                ...
                                <p><strong>Telephones : </strong>+91 7892213141 <br /><strong>Fax Nos : </strong>+91 7892213141<br /><strong>Email : </strong>
                                ...
                                <p><strong>Railway Head Office Exchange Number</strong> : +91 7892213141</p>
                                <p><strong>Fort Railway Station Inquiries</strong> : +91 7892213141</p>
                                <p><strong>Deputy Operating Superintendent</strong> : +91 7892213141</p>
                                <p className="MsoNormal"><strong>Assistant Transportation Superintendent (Operation)</strong> :+91 7892213141</p>
                            </div>
                        </Col>
                    </Row>
                </Col>
